...
In this lab you will have the freedom to combine a sensor and an actuator to create a
*smart system* of your own design.

To use this repository: clone this repository, open your PlatformIO home page, click on
`open project`, and select the folder you cloned.
...
- Go to `src` folder
  - Please edit this file `main.cpp` or click [here](src/main.cpp) to complete the
    assignment.
  - **Note:** We did not provide you with a skeleton code in this lab; you have to
...
**Note:** You can click `Upload and Monitor` as well. After you click Monitor, you
should see the print statements from your code, and your system working.
...
- **Can't monitor output?**
  ...
  - Check which pins are in use: A0-A5 are analog pins, but only A0 and A1 can be used
    for output.
